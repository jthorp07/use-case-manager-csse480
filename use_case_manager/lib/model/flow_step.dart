...
class FlowStep implements Comparable<FlowStep> {
  ...
  void setStep(String step) {
    _contents = step;
    UseCaseDocumentMngr.instance.updateFlowStep(docId: documentId!, contents: step, index: _index);
  }

  void setIndex(int index) {
    _index = index;
    UseCaseDocumentMngr.instance.updateFlowStep(docId: documentId!, contents: _contents, index: index);
  }
